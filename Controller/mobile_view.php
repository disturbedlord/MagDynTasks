...
<body class="">
    ...
    <div id="sidebar"
        ...
        <div class="flex-1 overflow-y-auto p-4">
            ...
            <button id="exportCSV"
                class=" w-full inline-flex items-center gap-2 px-4 py-2 border border-green-600 text-black hover:bg-green-50 text-sm font-medium rounded-lg transition-colors duration-200 cursor-pointer">
